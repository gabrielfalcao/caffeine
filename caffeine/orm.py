...
from caffeine.util import json
...
metadata = MetaData()
logger = logging.getLogger('caffeine.orm')
...
class Model(object):
    ...
    query_by = classmethod(lambda cls, order_by=None, **kw: cls.using(engine).query_by(order_by=order_by, **kw))
    ...
    def to_dictionary(self):
        """convenience method for subclasses that want to perform
        modifications in the dictionary output. This does not affect the
        behavior of the to_json() method."""
        return self.to_dict()
